#!/usr/bin/env python3
"""Build C_Representation for a subset."""
...
from scripts.C_Representation.pipeline import process_subset  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build CARE-PD C_Representation for a subset.")
    parser.add_argument("--subset", required=True, help="Subset name under outputs/B_Canonicalization.")
...
def main() -> int:
    ...
    return 0 if int(summary["failed_trials"]) == 0 else 1
